<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chartfloat.aspx.cs" Inherits="WebApplication1.chartdemo.chartfloat" %>
        ...
        <div>
            <div style="position: absolute; top: 0px; left: 0px; background-color: white; z-index: 22222; text-align: left">
                ...
                <div>
                    ...
                    <script type="text/javascript" src="chartfloat.js"></script>
                </div>
            </div>
        </div>
    </form>
